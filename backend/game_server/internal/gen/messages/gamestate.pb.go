...
const (
	GameOverReason_allRegularPlayersDied GameOverReason = 0
	GameOverReason_mainPlayerDied        GameOverReason = 1
)

// Enum value maps for GameOverReason.
var (
	GameOverReason_name = map[int32]string{
		0: "allRegularPlayersDied",
		1: "mainPlayerDied",
	}
...
func (GameOverReason) Descriptor() protoreflect.EnumDescriptor {
	return file_gamestate_proto_enumTypes[2].Descriptor()
}

func (GameOverReason) Type() protoreflect.EnumType {
	return &file_gamestate_proto_enumTypes[2]
}
...
type GameOver struct {
	...
	PlayersInfo     *RunningGamePlayersInfo `protobuf:"bytes,1,opt,name=players_info,json=playersInfo,proto3" json:"players_info,omitempty"`
	GameOverReason  GameOverReason          `protobuf:"varint,2,opt,name=game_over_reason,json=gameOverReason,proto3,enum=GameOverReason" json:"game_over_reason,omitempty"`
	MainPlayerScore uint64                  `protobuf:"varint,3,opt,name=main_player_score,json=mainPlayerScore,proto3" json:"main_player_score,omitempty"`
}
...
func (x *GameOver) GetPlayersInfo() *RunningGamePlayersInfo {
	if x != nil {
		return x.PlayersInfo
	}
	return nil
...
func (x *GameOver) GetGameOverReason() GameOverReason {
	if x != nil {
		return x.GameOverReason
	}
	return GameOverReason_allRegularPlayersDied
}

func (x *GameOver) GetMainPlayerScore() uint64 {
	if x != nil {
		return x.MainPlayerScore
	}
	return 0
...
var file_gamestate_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x6d, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x63,
	0x10, 0x01, 0x2a, 0x3f, 0x0a, 0x0e, 0x47, 0x61, 0x6d, 0x65, 0x4f, 0x76, 0x65, 0x72, 0x52, 0x65,
	0x61, 0x73, 0x6f, 0x6e, 0x12, 0x19, 0x0a, 0x15, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x67, 0x75, 0x6c,
	0x61, 0x72, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x44, 0x69, 0x65, 0x64, 0x10, 0x00, 0x12,
	0x12, 0x0a, 0x0e, 0x6d, 0x61, 0x69, 0x6e, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x44, 0x69, 0x65,
	0x64, 0x10, 0x01, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_gamestate_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_gamestate_proto_goTypes = []interface{}{
	...
	(GameOverReason)(0),            // 2: GameOverReason
	(*RootGameState)(nil),          // 3: RootGameState
	(*Player)(nil),                 // 4: Player
	(*RunningGamePlayersInfo)(nil), // 5: RunningGamePlayersInfo
	(*LobbyGameState)(nil),         // 6: LobbyGameState
	(*WaitForQuestionState)(nil),   // 7: WaitForQuestionState
	(*QuestionInfo)(nil),           // 8: QuestionInfo
	(*WaitForAnswerState)(nil),     // 9: WaitForAnswerState
	(*SpoiledAnswer)(nil),          // 10: SpoiledAnswer
	(*WaitForMainPlayerState)(nil), // 11: WaitForMainPlayerState
	(*GameOver)(nil),               // 12: GameOver
}
var file_gamestate_proto_depIdxs = []int32{
	6,  // 0: RootGameState.lobby:type_name -> LobbyGameState
	7,  // 1: RootGameState.wait_for_question:type_name -> WaitForQuestionState
	9,  // 2: RootGameState.wait_for_answer:type_name -> WaitForAnswerState
	11, // 3: RootGameState.wait_for_main_player:type_name -> WaitForMainPlayerState
	12, // 4: RootGameState.game_over:type_name -> GameOver
	0,  // 5: Player.player_type:type_name -> PlayerType
	4,  // 6: RunningGamePlayersInfo.players:type_name -> Player
	4,  // 7: LobbyGameState.players:type_name -> Player
	1,  // 8: LobbyGameState.choose_main_player_strategy:type_name -> ChooseMainPlayerStrategy
	5,  // 9: WaitForQuestionState.players_info:type_name -> RunningGamePlayersInfo
	5,  // 10: WaitForAnswerState.players_info:type_name -> RunningGamePlayersInfo
	8,  // 11: WaitForAnswerState.question_info:type_name -> QuestionInfo
	5,  // 12: WaitForMainPlayerState.players_info:type_name -> RunningGamePlayersInfo
	8,  // 13: WaitForMainPlayerState.question_info:type_name -> QuestionInfo
	10, // 14: WaitForMainPlayerState.spoiled_answers:type_name -> SpoiledAnswer
	5,  // 15: GameOver.players_info:type_name -> RunningGamePlayersInfo
	2,  // 16: GameOver.game_over_reason:type_name -> GameOverReason
