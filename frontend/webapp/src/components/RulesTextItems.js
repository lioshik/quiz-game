export default [
  {
    title: "About this game 111",
    text: `1 vs. 100 is an American game show that was broadcast by NBC from 2006 to 2008 and revived on Game Show Network (GSN) with a new series, which ran from 2010 to 2011. Based on the Dutch game show Eén tegen 100, the game features a single player (the "1") competing against 100 other contestants (known as "the Mob") in a trivia match. The 1 earns prize money depending on how many Mob members they have eliminated from the game, but loses all winnings with an incorrect answer at any point. The host of the original NBC version was Bob Saget, while Carrie Ann Inaba hosted the GSN revival.laksdjf;lasjfd;lasjf;lkajsdflkajdfljad;sflka;lsdfja;lsdjfa;lsjdf;alkjsdf;lajsdf;lajsf;lkajsdf;lajsd;flakjs;dflajsd;lfjas;lfdja;lsdfja;lsfjka;lksdfja;lsdfj`,
  },
  {
    title: "How to play 222",
